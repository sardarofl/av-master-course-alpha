// Audio Systems Course - Interactive JavaScript
...
function updateProgress() {
    ...
    const progress = (completedStages.length / 9) * 100;
...
document.addEventListener('keydown', function(e) {
    ...
    if (e.key === 'ArrowRight' && currentStage < 9) {
        navigateStage(currentStage + 1);
    }
});
...
window.addEventListener('load', function() {
    ...
    console.log('Audio Systems Course loaded successfully!');
...
function checkCompletion() {
    ...
    if (completed.length === 9) {
        setTimeout(() => {
            alert('🎉 Congratulations! You\'ve completed the entire Audio Systems Course! You\'re now ready to design professional audio systems!');
        }, 500);
    }
}
